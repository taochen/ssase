...
import org.ssase.model.sam.ml.ann.EncogFeedForwardNeuralNetwork;
import org.ssase.model.sam.ml.ann.NeuralNetworkStructureSelector;
import org.ssase.model.sam.ml.timeseries.ARMA;
import org.ssase.model.sam.ml.timeseries.ARMAStructureSelector;
import org.ssase.model.sam.ml.tree.RegressionTree;
 ...
 *
 */
public class SAMModel implements Model{
	...
	@Deprecated
	public SAMModel (String name, Set<Primitive> possibleInputs, QualityOfService output) {
		this.name = name;
