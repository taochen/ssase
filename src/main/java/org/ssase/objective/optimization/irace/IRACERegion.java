package org.ssase.objective.optimization.irace;
...
import jmetal.metaheuristics.irace.IRACE_SAS_main;
 ...
 *
 */
public class IRACERegion extends Region {
	...
	public IRACERegion(double[] weights) {
		this.weights = weights;	
	}
	
	
	public IRACERegion(double[] weights, double[][] fixed_bounds) {
		this.weights = weights;	
