package org.ssase.objective.optimization.paramils;
...
import jmetal.metaheuristics.paramils.ParamILS_SAS_main;
...
public class ParamILSRegion extends Region {

	protected int[][] vars = null;
	protected double[] weights;
	protected double[][] fixed_bounds;
	
	public ParamILSRegion() {
		super();		
	}
	
	public ParamILSRegion(double[] weights) {
		this.weights = weights;	
	}

	
	public ParamILSRegion(double[] weights, double[][] fixed_bounds) {
		this.weights = weights;	
