...
package org.ssascaling.model.selection.mi;
...
public abstract class MutualInformation
{
  ...
  public static double calculateSymmetricUncertainty (double[] firstVector, double[] secondVector) {
	  return 2 * calculateMutualInformation(firstVector, secondVector)/(Entropy.calculateEntropy(firstVector) + Entropy.calculateEntropy(secondVector)); 
  }
}
